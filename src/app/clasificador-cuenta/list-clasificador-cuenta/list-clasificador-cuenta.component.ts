                    ...
                    .subscribe({
                        next: response => {
                            ...
                            this.clasificadorCuentaConso = result.data.filter(
                                (f: {
                                    TipoClasificador: TiposClasificadorCuenta;
                                }) =>
                                    f.TipoClasificador ===
                                    TiposClasificadorCuenta.Consolidado
                            );
                            this.clasificadorCuentaCentro = result.data.filter(
                                (f: {
                                    ...
                                    f.TipoClasificador ===
                                    TiposClasificadorCuenta.Centro
                            );
                            this.clasificadorCuentaComplejo =
                                result.data.filter(
                                    (f: {
                                        TipoClasificador: TiposClasificadorCuenta;
                                    }) =>
                                        f.TipoClasificador ===
                                        TiposClasificadorCuenta.Complejo
                                );
                        },
                        error: err => {
                            this.loading = false;
                        ...
                        this._clasificadorCuentaSvc.subscription.push(
                            this._clasificadorCuentaSvc
                                ...
                                .subscribe({
                                    next: response => {
                                        const result =
                                            response.deleteClasificadorCuenta;
