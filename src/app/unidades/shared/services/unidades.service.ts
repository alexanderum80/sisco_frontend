...
export class UnidadesService {
  ...
  getAllUnidades(): Observable<UnidadesQueryResponse> {
    return new Observable<UnidadesQueryResponse>(subscriber => {
      try {
        this._apollo.query<UnidadesQueryResponse>({
  ...
  getUnidadesByIdSubdivision(idSubdivision: number): Observable<UnidadesQueryResponse> {
    return new Observable<UnidadesQueryResponse>(subscriber => {
      try {
        this._apollo.query<UnidadesQueryResponse>({
  ...
  getUnidadesByIdDivision(idDivision: number): Observable<UnidadesQueryResponse> {
    return new Observable<UnidadesQueryResponse>(subscriber => {
      try {
        this._apollo.query<UnidadesQueryResponse>({
